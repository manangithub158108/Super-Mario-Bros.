...
function setup(){
    ...
    superMario.scale = 4;
    superMario.setCollider("rectangle", 0, 0, 20, 30);
...
function draw(){
    ...
    if(gameState === 0){
        ...
        textFont("georgia");
        fill("yellow");
        text("Welcome to the Classical Super Mario Game", 200, 40); 
    ...
    if(gameState === 1){
        ...
        textFont("georgia");
        fill("yellow");
        text("1) There will be the super mario for the game.", 50, 100); 
        ...
        textFont("georgia");
        fill("yellow");
        text("4) Dodge from all kind of all obstacles (fireshots and the spiny animal).", 50, 250); 
  ...
  // defining the gameState play
    if(gameState === 2){
        ...
        if(frameCount % 390 === 0){
            ...
            fireBall.scale = 3;
            fireBall.setCollider("circle", 0, 0, 10);
